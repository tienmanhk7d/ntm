  ...
  if ($graph !== FALSE) {
    ...
    if (isset($json->data) && count($json->data) > 0) {
      foreach ($json->data as $comment) {
        if (strpos($comment->message, '.facebook.com/groups/') !== FALSE && $comment->from->id !== '100005722300314') {
          $result[] = $comment->id;
        }
      }
...
scan('683869265101326_675300022624917'); // EDIT HERE